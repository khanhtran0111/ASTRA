...
import { useUpdateTaskPriority } from '../../../../../../src/modules/planner/hooks/mutations/update-task-priority';
...
describe('useUpdateTaskPriority', () => {
  it('sends priority_number and invalidates task + plan on success', async () => {
    ...
    const { result } = renderHook(() => useUpdateTaskPriority('p1'), { wrapper: Wrapper });

    result.current.mutate({ task_id: 't1', expected_version: 3, priority_number: 9 });
